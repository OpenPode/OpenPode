...
protected:
	...
	void determine_z_paws_position_not_get_up(Side &side, int sequence_number, Incline_coef_t p_incline_coef);
...
private:
	...
	bool test_for_good_position_z(Side &side,Incline_coef_t p_incline_coef, int paw_spreading, int sequence_number);
